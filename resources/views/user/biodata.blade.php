                        ...
                        <div class="card-header">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 badge-biodata text-right">
                                    ...
                                    @if($data->biodata->status=='Belum Verifikasi')<a href="{{route('user-edit-biodata')}}" class="btn btn-success btn-edit-biodata btn-sm float-right">Edit</a>@endif
                                </div>
                            </div>   
                        </div>
